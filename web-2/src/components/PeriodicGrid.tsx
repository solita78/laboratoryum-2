...
export function PeriodicGrid({ experiments, limit = 25 }: Props) {
  ...
  const periodicPositions: CellPos[] = [
    { col: 1, row: 1 }, { col: 6, row: 1 },
    { col: 1, row: 2 }, { col: 2, row: 2 }, { col: 4, row: 2 }, { col: 5, row: 2 }, { col: 6, row: 2 },
    { col: 1, row: 3 }, { col: 2, row: 3 }, { col: 4, row: 3 }, { col: 5, row: 3 }, { col: 6, row: 3 },
    { col: 1, row: 4 }, { col: 2, row: 4 }, { col: 3, row: 4 }, { col: 4, row: 4 }, { col: 5, row: 4 }, { col: 6, row: 4 },
    { col: 1, row: 5 }, { col: 2, row: 5 }, { col: 3, row: 5 }, { col: 4, row: 5 }, { col: 5, row: 5 }, { col: 6, row: 5 },
    { col: 1, row: 6 }, { col: 2, row: 6 }, { col: 3, row: 6 }, { col: 4, row: 6 }, { col: 5, row: 6 }, { col: 6, row: 6 },
    { col: 1, row: 7 }, { col: 2, row: 7 },
  ];
    ...
    <section className="periodic-section" aria-labelledby="periodic-title">
      ...
      <div className="periodic-shell">
        <div className="periodic-grid" role="list">
          {items.map((exp, idx) => {
            const pos = periodicPositions[idx] ?? periodicPositions[periodicPositions.length - 1];
